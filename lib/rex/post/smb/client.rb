...
class Client
  ...
  #
  # Initialize the smb instance
  #
  def init_smb(connection,opts={})
  ...
  attr_reader :ext, :connection
protected
  attr_writer   :commands # :nodoc:
  attr_accessor :ext_aliases # :nodoc:
  attr_writer   :ext, :connection # :nodoc:
